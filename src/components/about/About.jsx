        ...
        <div className="aboutMe-2 row">
          ...
          <div className="aboutMe-2-2 col-lg-7 col-sm-12">
            ...
            <p className="opacity-80">
              Passionate self-taught developer with four months of internship
              experience, dedicated to crafting visually appealing and
              functional user interfaces. Seeking opportunities to apply my
              front-end skills in a dynamic organization, with a focus on
